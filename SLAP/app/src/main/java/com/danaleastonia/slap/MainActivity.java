...
public class MainActivity extends AppCompatActivity implements ProfileFragment.OnFragmentInteractionListener, FeedFragment.OnFragmentInteractionListener, FriendsFragment.OnFragmentInteractionListener {
    ...
    private void startAddFriendPage() {
        Intent intent = new Intent(getApplicationContext(), AddNewFriend.class);
        startActivity(intent);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            ...
            sharedPreferences.edit().putString(LOGGEDIN_USER_EMAIL, null).apply();
        ...
        if (id == R.id.action_add_dummy_data) {
            SlapUtil.insertDummyFeedData(getApplicationContext());
            SlapUtil.insertDummyFriendsData(getApplicationContext());
            return true;
        }
